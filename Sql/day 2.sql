...
#Inner join
select e.id, name, e.age,d.dept_id,e.dept_id,d.dept_name from dept d inner join  emp e  on e.dept_id=d.dept_id; 

#Right join
select e.id, name, e.age,e.dept_id,d.dept_name from dept d Right join  emp e on e.dept_id=d.dept_id;

#left join
select e.id, name, e.age,e.dept_id,d.dept_id,d.dept_name from dept d left join emp e  
on e.dept_id=d.dept_id order by id asc; 
select * from dept;
select * from emp;
